  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-kid-candy px-4 py-10 text-maroon">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center font-kid">
        ...
        <div className="kid-card kid-gradient-bubblegum w-full p-8 md:p-12 animate-slide-up">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="kid-pill kid-pill-sunny rounded-2xl p-5 text-left shadow-lg">
              <div className="text-4xl">🏆</div>
            ...
            <div className="kid-pill kid-pill-mint rounded-2xl p-5 text-left shadow-lg">
              <div className="text-4xl">🌈</div>
          ...
          <button
            ...
            className="kid-button kid-button-sunset mt-10 w-full py-4 text-xl font-extrabold"
          >
