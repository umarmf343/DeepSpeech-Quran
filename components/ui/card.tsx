...
const CardTitle = React.forwardRef<CardElement, CardProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
const CardDescription = React.forwardRef<CardElement, CardProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
...
const CardAction = React.forwardRef<CardElement, CardProps>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
